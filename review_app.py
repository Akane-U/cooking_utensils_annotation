...
<li>菜箸とおたまセットで盛り付けているものは、おたまだけでできないか確認</li>
<li>調味料を混ぜたボウルを移動するための道具の有無→液体・半固体かで区別</li>
<li>煮物で汁気がある際は、盛り付けにおたまも使用すべきか→記入するに統一</li>
<li>拭きとった残った脂などの副産物は盛り付けない</li>
<li>ラップ・アルミ・糸で覆うときに、生成物が材料を重ねたものを対象とするならば、接していない層に道具を書くべきか→記入しないに統一（串は刺していて接触するので記入）</li>
<li>取り除く・串を刺す際は、それまでに触れる生成元全てに対して道具を記入</li>
